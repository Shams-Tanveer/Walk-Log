                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Obx(() {
                          return MyButton(
                            text: "Start Walking",
                            onPressed: setLimitController.setLimit.value.errorInSetLimit? (){} :() {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => DistanceTracking(
                            ...
                            fromLeft: setLimitController.setLimit.value.errorInSetLimit?Colors.grey.shade400:Colors.greenAccent,
                            toRight:  setLimitController.setLimit.value.errorInSetLimit?Colors.grey.shade400:Colors.greenAccent.shade700,
                          );
                        }),
                        MyButton(
                            text: "History",
